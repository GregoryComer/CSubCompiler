...
{
    public class DoubleMinusUnaryPreOperatorNode : UnaryPreOperatorNode
    {
        public DoubleMinusUnaryPreOperatorNode(SubExpressionNode operand, Token token, int tokenIndex) : base(UnaryPreOperatorType.DoubleMinus, operand, token, tokenIndex)
        {
        }
